...
#
# project_2.tcl: Tcl script for re-creating project 
#
# Generated by Vivado on Sun Feb 23 16:59:23 EST 2025
...
#    "/nfs/cms/tracktrigger/wittich/test_fpga/Cornell_CM_Rev3_HW/Vivado/src/toplevel.v"
#    "/nfs/cms/tracktrigger/wittich/test_fpga/Cornell_CM_Rev3_HW/Vivado/ip/clk/clk_wiz_0.xci"
#    "/nfs/cms/tracktrigger/wittich/test_fpga/Cornell_CM_Rev3_HW/Vivado/ip/vio/vio_freq.xci"
#    "/nfs/cms/tracktrigger/wittich/test_fpga/Cornell_CM_Rev3_HW/Vivado/constraints/VU13P_pins.xdc"
#    "/nfs/cms/tracktrigger/wittich/test_fpga/Cornell_CM_Rev3_HW/Vivado/constraints/clocks.xdc"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xcvu13p-flga2577-1-e
...
set_property -name "part" -value "xcvu13p-flga2577-1-e" -objects $obj
...
set file "$origin_dir/src/reg_map.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/i2c_slave.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/src/toplevel.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/ip/clk/clk_wiz_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/ip/vio/vio_freq.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set file "[file normalize "$origin_dir/constraints/VU13P_pins.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/VU13P_pins.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constraints/design.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/design.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_part" -value "xcvu13p-flga2577-1-e" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvu13p-flga2577-1-e -flow {Vivado Synthesis 2023} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvu13p-flga2577-1-e -flow {Vivado Implementation 2023} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
